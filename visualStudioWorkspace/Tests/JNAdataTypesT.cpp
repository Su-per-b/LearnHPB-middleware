...
namespace StraylightTests
{
	...
	TEST_CLASS(JNAdataTypesT)
	{
		...
		TEST_METHOD(T04_ScalarVariablesAllStruct)
		{
			...
			ScalarVariablesAllStruct * svAll = test_GetScalarVariablesAllStruct();

			ScalarVariableRealStruct * realVariableAry = svAll->input->realValue;
			int realSize = svAll->input->realSize;
