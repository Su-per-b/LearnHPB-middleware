; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	E:\SRI\straylight_repo\visualStudioWorkspace\zlib-1.2.6\crc32.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File e:\sri\straylight_repo\visualstudioworkspace\zlib-1.2.6\crc32.c
...
; 242  :         endian = 1;
	...
	mov	DWORD PTR _endian$80281[ebp], 1

; 243  :         if (*((unsigned char *)(&endian)))

	movzx	eax, BYTE PTR _endian$80281[ebp]
	test	eax, eax
	je	SHORT $LN8@crc32
...
; 286  :         DOLIT32;
	...
	shr	ecx, 8
	and	ecx, 255				; 000000ffH
	mov	edx, DWORD PTR _crc_table[eax*4+3072]
	xor	edx, DWORD PTR _crc_table[ecx*4+2048]
	mov	eax, DWORD PTR _c$[ebp]
	shr	eax, 16					; 00000010H
	and	eax, 255				; 000000ffH
	xor	edx, DWORD PTR _crc_table[eax*4+1024]
	mov	ecx, DWORD PTR _c$[ebp]
...
; 320  :         c = crc_table[4][(c >> 24) ^ *buf++] ^ (c << 8);
	...
	mov	ecx, DWORD PTR _c$[ebp]
	shl	ecx, 8
	xor	ecx, DWORD PTR _crc_table[eax*4+4096]
	mov	DWORD PTR _c$[ebp], ecx
...
; 327  :         DOBIG32;
	...
	shr	ecx, 8
	and	ecx, 255				; 000000ffH
	mov	edx, DWORD PTR _crc_table[eax*4+4096]
	xor	edx, DWORD PTR _crc_table[ecx*4+5120]
	mov	eax, DWORD PTR _c$[ebp]
	shr	eax, 16					; 00000010H
	and	eax, 255				; 000000ffH
	xor	edx, DWORD PTR _crc_table[eax*4+6144]
	mov	ecx, DWORD PTR _c$[ebp]
	shr	ecx, 24					; 00000018H
	xor	edx, DWORD PTR _crc_table[ecx*4+7168]
	mov	DWORD PTR _c$[ebp], edx
	mov	eax, DWORD PTR _buf4$[ebp]
	add	eax, 4
	mov	DWORD PTR _buf4$[ebp], eax
...
; 392  :     odd[0] = 0xedb88320UL;          /* CRC-32 polynomial */
	...
	mov	DWORD PTR _odd$[ebp], -306674912	; edb88320H
...
; 410  :         if (len2 & 1)
	...
	mov	DWORD PTR tv142[ebp+4], ecx
	mov	edx, DWORD PTR tv142[ebp]
	or	edx, DWORD PTR tv142[ebp+4]
