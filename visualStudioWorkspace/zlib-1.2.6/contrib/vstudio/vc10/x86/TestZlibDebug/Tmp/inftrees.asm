; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	E:\SRI\straylight_repo\visualStudioWorkspace\zlib-1.2.6\inftrees.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
_inflate_copyright DB ' inflate 1.2.6 Copyright 1995-2012 Mark Adler ', 00H
	ORG $+1
...
; File e:\sri\straylight_repo\visualstudioworkspace\zlib-1.2.6\inftrees.c
...
; 281  :                 (type == DISTS && used >= ENOUGH_DISTS))
	...
	cmp	DWORD PTR _used$[ebp], 852		; 00000354H
	jae	SHORT $LN3@inflate_ta
$LN2@inflate_ta:
	cmp	DWORD PTR _type$[ebp], 2
	jne	SHORT $LN4@inflate_ta
	cmp	DWORD PTR _used$[ebp], 592		; 00000250H
	jb	SHORT $LN4@inflate_ta
$LN3@inflate_ta:
