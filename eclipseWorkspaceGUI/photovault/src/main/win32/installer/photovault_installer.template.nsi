...
; Finish page
!define MUI_FINISHPAGE_TEXT "Thank you for installing Photovault!\r\n\nWe appreciate your feedback, so whether you like Photovault or not, please drop an email to feedback@photovault.org"
...
; Shortcuts
  ...
  CreateShortCut "$SMPROGRAMS\$ICONS_GROUP\Photovault.lnk" "$INSTDIR\photovault.exe"
  CreateShortCut "$DESKTOP\Photovault.lnk" "$INSTDIR\photovault.exe"
...
Section -Post
  ...
  WriteRegStr HKLM "${PRODUCT_DIR_REGKEY}" "" "$INSTDIR\Photovault.exe"
...
Section Uninstall
  ...
  Delete "$DESKTOP\Photovault.lnk"
  Delete "$SMPROGRAMS\$ICONS_GROUP\Photovault.lnk"
