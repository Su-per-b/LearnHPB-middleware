...
public class ScalarVariablePanelReal extends JPanel {
	 ...
	 * Create the panel.
	 */
	public ScalarVariablePanelReal(InputDetailView inputDetailView) {
	...
	public void submitSliderChange() {
		...
		btnSubmit_.setEnabled(newDoubleValue !=theValue_);
	...
	public void setValue(double valueDouble) {
		...
		theValue_ = valueDouble;
		String valueStr = String.valueOf(valueDouble);
