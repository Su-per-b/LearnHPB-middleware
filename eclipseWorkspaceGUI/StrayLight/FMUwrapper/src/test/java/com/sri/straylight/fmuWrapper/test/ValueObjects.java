...
public class ValueObjects extends TestCase {
	...
	public class InitThread  extends Thread
	{
		...
		public void run()
		{
			...
			ValueObjects.nextStateExpected = SimStateServer.simStateServer_1_connect_completed;
			...
			ValueObjects.nextStateExpected = SimStateServer.simStateServer_2_xmlParse_completed;
			fmuController_.xmlParse();
			awaitOnBarrier(barrier);
			
			ValueObjects.nextStateExpected = SimStateServer.simStateServer_3_init_completed;
			fmuController_.init();
			awaitOnBarrier(barrier);
			awaitOnBarrier(mainBarrier);
