 ...
 */
public enum SimStateWrapper implements JnaEnum<SimStateWrapper>, JsonSerializable  {
	 ...
	 */
	public SimStateWrapper getForValue(int i) {
	    for (SimStateWrapper o : SimStateWrapper.values()) {
	        if (o.getIntValue() == i) {
	            return o;
	        }
	    }
