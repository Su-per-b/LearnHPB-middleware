...
import com.sri.straylight.socketserver.Config;
...
public class SimulationController extends AbstractController  {
	...
	public void onSimStateWrapperNotify(SimStateWrapperNotify event) {
		...
		SimStateWrapperNotify newEvent = new SimStateWrapperNotify(this,fmuWrapperState);
		String jsonString = newEvent.toJson();
