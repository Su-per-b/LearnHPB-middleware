...
public class VoManagedSerialization {
    ...
    public void scalarVariablesAll_serialize() {
		...
		Vector<ScalarVariableReal> realList = new Vector<ScalarVariableReal>();
		realList.add(scalarVariableReal_0);
		realList.add(scalarVariableReal_1);
		
		
		ScalarVariableCollection collection = new ScalarVariableCollection();
		collection.setRealVarList(realList);
		
		
		//make scalarVariablesAll 1
		ScalarVariablesAll scalarVariablesAll = new ScalarVariablesAll();
		scalarVariablesAll.setInput(collection);
		scalarVariablesAll.setOutput(collection);
		scalarVariablesAll.setInternal(collection);
